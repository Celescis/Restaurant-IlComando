...
@Component({
  selector: 'app-graficos-clientes',
  templateUrl: './graficos-clientes.page.html',
  styleUrls: ['./graficos-clientes.page.scss'],
})
export class GraficosClientesPage implements OnInit {
              ...
              callbacks: {
                ...
                labelPointStyle: (context) => {
                  ...
                  if (context.dataIndex == 0) {
                    ...
                    context.formattedValue = 'Regular';
                  } else {
  ...
  generarChartClienteVariedadMenu() {
    ...
    setTimeout(() => {
      ...
      this.chart = new Chart(ctx, {
        type: 'pie',
        data: {
          labels: ['Si y me gustaron', 'Si y no me gustaron', 'No los probo'],
          datasets: [
            {
              label: 'Humor',
              ...
              callbacks: {
                ...
                labelPointStyle: (context) => {
                  ...
                  if (context.dataIndex == 0) {
                    ...
                    context.formattedValue = 'Si y me gustaron';
                  } else if (context.dataIndex == 1) {
                    ...
                    context.formattedValue = 'Si y no me gustaron';
                  } else {
                    ...
                    context.label = '  ' + porcentajeExcelente + '% ';
                    context.formattedValue = 'No los probo';
                  }
                  return {
                    pointStyle: context.dataIndex,
                  };
