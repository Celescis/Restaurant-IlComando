...
@Component({
  selector: 'app-encuesta-de-supervisor',
  templateUrl: './encuesta-de-supervisor.page.html',
  styleUrls: ['./encuesta-de-supervisor.page.scss'],
})
export class EncuestaDeSupervisorPage implements OnInit {
              ...
              callbacks: {
                ...
                labelPointStyle: (context) => {
                  ...
                  if (context.dataIndex == 0) {
                    ...
                    context.formattedValue = 'Mas o menos';
                  } else {
              ...
              callbacks: {
                ...
                labelPointStyle: (context) => {
                  ...
                  if (context.dataIndex == 0) {
                    ...
                    context.formattedValue = 'Excelentes';
                  } else if (context.dataIndex == 1) {
                    ...
                    context.formattedValue = 'Muy malas';
                  }
                  return {
                    pointStyle: context.dataIndex,
                  };
