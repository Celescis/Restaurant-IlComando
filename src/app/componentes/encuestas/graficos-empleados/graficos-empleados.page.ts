...
@Component({
  selector: 'app-graficos-empleados',
  templateUrl: './graficos-empleados.page.html',
  styleUrls: ['./graficos-empleados.page.scss'],
})
export class GraficosEmpleadosPage implements OnInit {
